...
if not exist "%USB_ROOT%\GD32_ISP_CLI" mkdir "%USB_ROOT%\GD32_ISP_CLI"
...
echo set "GDCLI_PATH=%%ROOT_DIR%%\Apps\GD32_ISP_CLI" >> "%USB_ROOT%\Lancia_MSYS2.bat"
echo. >> "%USB_ROOT%\Lancia_MSYS2.bat"
...
echo set "PATH=%%ARM_GCC_PATH%%;%%GEANY_PATH%%;%%OPENOCD_PATH%%;%%GDCLI_PATH%%;%%PATH%%" >> "%USB_ROOT%\Lancia_MSYS2.bat"
echo. >> "%USB_ROOT%\Lancia_MSYS2.bat"
...
echo set "GDCLI_PATH=%%ROOT_DIR%%\Apps\GD32_ISP_CLI" >> "%USB_ROOT%\Lancia_Geany.bat"

echo. >> "%USB_ROOT%\Lancia_Geany.bat"

echo :: Aggiunge GCC, OpenOCD e i tool MSYS2 (make, nano) al PATH per farli vedere a Geany >> "%USB_ROOT%\Lancia_Geany.bat"
echo set "PATH=%%ARM_GCC_PATH%%;%%GEANY_PATH%%;%%OPENOCD_PATH%%;%%GDCLI_PATH%%;%%PATH%%" >> "%USB_ROOT%\Lancia_Geany.bat"
...
echo set "EXE_NAME=EmbeddedBuilder.exe" >> "%USB_ROOT%\Lancia_EmbeddedBuilder.bat"
